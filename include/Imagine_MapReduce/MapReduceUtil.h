...
class MapReduceUtil
{
 public:
    ...
    static void GenerateTaskCompleteMessage(Internal::TaskCompleteRequestMessage* request_msg, Internal::Identity send_identity, const std::string& file_name, size_t split_id, size_t split_num, const std::string& listen_ip, const std::string& listen_port, const std::vector<std::string>& file_list);\

    static void GenerateStartReduceMessage(Internal::StartReduceRequestMessage* request_msg, const std::string& master_ip, const std::string& master_port, const std::vector<std::string>& file_list);
