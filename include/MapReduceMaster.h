...
class MapReduceMaster
{
 ...
 public:
    MapReduceMaster(const std::string &ip, const std::string &port, const std::string &keeper_ip, const std::string &keeper_port, const int reducer_num = DEFAULT_REDUCER_NUM);
